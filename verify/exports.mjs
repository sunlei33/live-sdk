...
const core = ['createPlayer','Player','BasePlugin','UIMount','HlsKernel','NativeKernel','WebEnvAdapter','ConsoleReporter','SentryReporter','LivePolling','Events','ERROR_CODE','deepMerge','sniffer','logger']
